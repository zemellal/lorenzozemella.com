...
- Rapid prototyping with AI tools, LLM integration, production deployment

### Full-stack

- **Languages:** TypeScript, Python
- **Frameworks:** React, Next.js, Tanstack Start, Astro, FastAPI, Hono, Express
- **UI:** Tailwind CSS, Shadcn/UI, Material UI
- **Data:** Tanstack, Prisma, PostgreSQL, SQLite
